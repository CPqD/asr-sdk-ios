...
//! Project version number for CPqDASR.
FOUNDATION_EXPORT double CPqDASRVersionNumber;

//! Project version string for CPqDASR.
FOUNDATION_EXPORT const unsigned char CPqDASRVersionString[];
...
#import <CPqDASR/CPqDASRMicAudioSource.h>
